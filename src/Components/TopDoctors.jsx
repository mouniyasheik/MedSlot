...
const TopDoctors = () => {
    ...
    return (
      <div className='flex flex-col items-center g-4 my-16 text-gray-900 md:mx-10'>
        ...
        <button onClick={()=>{navigate('/doctors');scrollTo(0,0);}}  className='bg-blue-400 text-gray-600 px-7 py-3 rounded-full mt-10'>More</button>
      </div>
